...
<table align="center">
<tr><td>First Name:</td><td><input type="text" class="form-control form-control-sm" style="background-color:#EA80FC; font-weight:bold;" name="firstname" maxlength="15" value="<?php echo $firstName; ?>"></td></tr>
<tr><td>Last Name:</td><td><input type="text" class="form-control form-control-sm" style="background-color:#B388FF; font-weight:bold;" name="lastname" maxlength="15" value="<?php echo $lastName; ?>"></td></tr>
<tr><td>Email Address:</td><td><input type="text" class="form-control form-control-sm" style="background-color:#EA80FC; font-weight:bold;" name="email" maxlength="100" value="<?php echo $email; ?>"></td></tr>
<tr><td>&nbsp;</td></td><td><input type="submit" class="btn btn-primary active btn-sm btn-block" name="update" value="Update Profile"></td></tr>
</table>
</form>
<hr>
</div>
