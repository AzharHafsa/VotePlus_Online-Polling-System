...
<tr>
    ...
    <td><SELECT NAME="position" id="position" class="form-control form-control-sm" >
    ...
    <td><input type="submit" class="btn btn-primary active btn-sm btn-block" name="Submit" value="See Candidates" /></td>
</tr>
<tr>
    <td>&nbsp;</td> 
    <td>&nbsp;</td>
...
?>
<tr>
    <h3>NOTE: Click a circle under a respective candidate to cast your vote. You can't vote more than once in a respective position. This process can not be undone so think wisely before casting your vote.</h3>
    <td>&nbsp;</td>
</tr>
</form>
</table>
