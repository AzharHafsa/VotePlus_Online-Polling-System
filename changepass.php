...
<form action="changepass.php?id=<?php echo $_SESSION['member_id']; ?>" method="post" onSubmit="return updateValidate(this)">
<table align="center">
<tr><td>Old Password:</td><td><input type="password" class="form-control form-control-sm" style="background-color:#EA80FC; font-weight:bold;" name="oldpass" placeholder="Your Old Password" maxlength="15" value=""></td></tr>
<tr><td>New Password:</td><td><input type="password" placeholder="Your New password" class="form-control form-control-sm" style="background-color:#B388FF; font-weight:bold;" name="newpass" maxlength="15" value=""></td></tr>
<tr><td>Confirm New Password:</td><td><input type="password" placeholder="Your New Password" class="form-control form-control-sm" style="background-color:#EA80FC; font-weight:bold;" name="conpass" maxlength="15" value=""></td></tr>
<tr><td>&nbsp;</td></td><td><input type="submit" class="btn btn-primary active btn-sm btn-block" name="changepass" value="Update Password"></td></tr>
</table>
</form>
<hr>
</div>
